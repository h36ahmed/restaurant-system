...
var alertCreateOfferModalCtrl = function($scope, modalService) {
  ...
  $scope.close = modalService.reject;

  $scope.goToCreateMealOffer = modalService.resolve;
...
alertCreateOfferModalCtrl.inject = ['$scope', 'modalService'];

app.controller('alertCreateOfferModalCtrl', alertCreateOfferModalCtrl);
